...
import {
  ...
  Stethoscope, Scale, BarChart3, Settings, LogOut
} from 'lucide-react'
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-cabinet-blue flex flex-col z-40">
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <div className="text-white font-bold text-lg leading-tight">CHICHE COHEN</div>
        <div className="text-cabinet-blue-light text-xs mt-0.5 opacity-80">CRM Dommage Corporel</div>
      </div>
